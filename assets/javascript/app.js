...
function setGame() {
	...
	$("#gameContainer").html("<div><p>Shot Clock: " + parseInt(shotClock) + "</p></div>");
	$("#gameContainer").append("<div><p>" + questions.questionOne.question + "</p></div>");
	div.addClass("gameTimeQs");
	div.text(questions.questionOne.answer1);
	$("#gameContainer").append(div);
	div.text(questions.questionOne.answer2);
	$("#gameContainer").append(div);
	div.text(questions.questionOne.answer3);
	$("#gameContainer").append(div);
	div.text(questions.questionOne.answer4);
	$("#gameContainer").append(div);
